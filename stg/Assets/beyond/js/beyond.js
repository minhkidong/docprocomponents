...
function InitiateSideMenu() {
    ...
    //Sidebar Menu Handle CUSTOM
    $(".page-sidebar .sidebar-menu .menu-dropdown").on('click', function (e) {
        e.preventDefault();
...
function InitiateWidgets() {
    $(document).on("click", '.widget-buttons *[data-toggle="maximize"]', function (event) {
    ...
    $(document).on("click", '.widget-buttons *[data-toggle="collapse"]', function (event) {
        event.preventDefault();
        var widget = $(this).parents(".widget").eq(0);
    ...
    $(document).on("click", '.widget-buttons *[data-toggle="dispose"]', function (event) {
        event.preventDefault();
...
jQuery(document).ready(function () {
    ...
    if (jQuery(document).width() > 880) {
        jQuery('.sidebar-menu li ul li.active').parents('ul.submenu').css('display', 'block');
    }
});