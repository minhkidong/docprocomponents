...
var PageView = function pageView(container, id, scale, defaultViewport,
  ...
  this.draw = function pageviewDraw(callback) {
    ...
    if (!PDFJS.disableTextLayer) {
      ...
      textLayerDiv.id = 'textLayer' + this.id; //edit by xuanhieu@jamcorp.vn
    ...
    //try{ OCR.layer(jQuery('#textLayer' + this.id)); }catch(e){}; //xuanhieu@jamcorp.vn
  };
...
var PDFViewer = (function pdfViewer() {
  ...
  PDFViewer.prototype = /** @lends PDFViewer.prototype */{
    ...
    scrollPageIntoView: function PDFViewer_scrollPageIntoView(pageNumber,
      ...
      if(dest[1].name == 'XYZ'){
        scrollIntoView(pageViewDiv, { left: x, top: y-50 });
      }else{
    ...
    _updateLocation: function (firstPage) {
      ...
      this.location = {
        ...
        top: parseInt(pageNumber) == 1 ? 0 : intTop,
        left: intLeft,
...
function webViewerLoad(evt) {
  if(jQuery("#DEFAULT_URL").length > 0){
    try{
...
function webViewerInitialized() {
  ...
  var file = 'file' in params ? params.file : jQuery("#DEFAULT_URL").val();
